...
apptainer run --writable-tmpfs --bind "$cwd:$cwd" /home/dendezia/tool/for_ginger/tools_GINGER_v1.0.1.sif /bin/bash -c ". /root/bashrc4exec ; /nextflow -c $gingerDirInDockerImage/nextflow.config.base -c $nextflowConfigFileByUser -log $pdir/nextflow.log run $gingerDirInDockerImage/mapping.nf -work-dir $pdir/work" > $pdir/mapping.stdout 2> $pdir/mapping.stderr
GINGER
...
apptainer run --writable-tmpfs --bind "$cwd:$cwd" /home/dendezia/tool/for_ginger/tools_GINGER_v1.0.1.sif /bin/bash -c ". /root/bashrc4exec ; /nextflow -c $gingerDirInDockerImage/nextflow.config.base -c $nextflowConfigFileByUser -log $pdir/nextflow.log run $gingerDirInDockerImage/denovo.nf -work-dir $pdir/work" > $pdir/denovo.stdout 2> $pdir/denovo.stderr
GINGER
...
apptainer run --writable-tmpfs --bind "$cwd:$cwd" /home/dendezia/tool/for_ginger/tools_GINGER_v1.0.1.sif /bin/bash -c ". /root/bashrc4exec ; /nextflow -c $gingerDirInDockerImage/nextflow.config.base -c $nextflowConfigFileByUser -log $pdir/nextflow.log run $gingerDirInDockerImage/homology.nf -work-dir $pdir/work" > $pdir/homology.stdout 2> $pdir/homology.stderr
GINGER
...
apptainer run --writable-tmpfs --bind "$cwd:$cwd" /home/dendezia/tool/for_ginger/tools_GINGER_v1.0.1.sif /bin/bash -c ". /root/bashrc4exec ; /nextflow -c $gingerDirInDockerImage/nextflow.config.base -c $nextflowConfigFileByUser -log $pdir/nextflow.log run $gingerDirInDockerImage/abinitio.nf -work-dir $pdir/work" > $pdir/abinitio.stdout 2> $pdir/abinitio.stderr
GINGER
...
apptainer run --writable-tmpfs --bind "$cwd:$cwd" /home/dendezia/tool/for_ginger/tools_GINGER_v1.0.1.sif /bin/bash -c ". /root/bashrc4exec ; cd $pdir; bash $gingerDirInDockerImage/phase0.sh $nextflowConfigFileByUser" > $pdir/phase0.stdout 2> $pdir/phase0.stderr 
GINGER
...
apptainer run --writable-tmpfs --bind "$cwd:$cwd" /home/dendezia/tool/for_ginger/tools_GINGER_v1.0.1.sif /bin/bash -c ". /root/bashrc4exec ; cd $pdir; bash $gingerDirInDockerImage/phase1.sh $nextflowConfigFileByUser" > $pdir/phase1.stdout 2> $pdir/phase1.stderr 
GINGER
...
apptainer run --writable-tmpfs --bind "$cwd:$cwd" /home/dendezia/tool/for_ginger/tools_GINGER_v1.0.1.sif /bin/bash -c ". /root/bashrc4exec ; cd $pdir; bash $gingerDirInDockerImage/phase1_manual.sh $nextflowConfigFileByUser $opt_phase1manual" > $pdir/phase1_manual.stdout 2> $pdir/phase1_manual.stderr 
GINGER
...
apptainer run --writable-tmpfs --bind "$cwd:$cwd" /home/dendezia/tool/for_ginger/tools_GINGER_v1.0.1.sif /bin/bash -c ". /root/bashrc4exec ; cd $pdir; bash $gingerDirInDockerImage/phase2.sh $tc_threshold" > $pdir/phase2.stdout 2> $pdir/phase2.stderr
GINGER
...
apptainer run --writable-tmpfs --bind "$cwd:$cwd" /home/dendezia/tool/for_ginger/tools_GINGER_v1.0.1.sif /bin/bash -c ". /root/bashrc4exec ; cd $pdir; bash $gingerDirInDockerImage/summary.sh $nextflowConfigFileByUser" > $pdir/summary.stdout 2> $pdir/summary.stderr 
GINGER
...
apptainer run --writable-tmpfs --bind "$cwd:$cwd" /home/dendezia/tool/for_ginger/tools_GINGER_v1.0.1.sif /bin/bash -c ". /root/bashrc4exec ; /nextflow -c $gingerDirInDockerImage/nextflow.config.base -c $nextflowConfigFileByUser -log $pdir/nextflow.log run $gingerDirInDockerImage/ginger.nf -work-dir $pdir/work" > $pdir/ginger.stdout 2> $pdir/ginger.stderr
#apptainer run --writable-tmpfs --bind "$cwd:$cwd" /home/dendezia/tool/for_ginger/tools_GINGER_v1.0.1.sif /bin/bash -c ". /root/bashrc4exec ; /nextflow -c $gingerDirInDockerImage/nextflow.config.base -c $nextflowConfigFileByUser -log $pdir/nextflow.log run $gingerDirInDockerImage/ginger.nf -work-dir $pdir/work" > $pdir/ginger.stdout 2> $pdir/ginger.stderr
